<div class="footer_inner container">
	...
	<nav class="nav pc">
		<ul class="nav--list">
			...
			<li class="nav--item">
				...
				<ul class="nav-dec">
					<li class="nav-dec--item">
						<a href="" class="nav--link nav--link--regular">・面接のコツ</a>
					</li>
					<li>
						<a href="" class="nav--link nav--link--regular">・履歴書の書き方</a>
					</li>
				</ul>
			</li>
	...
	<div class="copy">
		<small>copyright&copy; saiiku channel all rights reserved.</small>
	</div>
